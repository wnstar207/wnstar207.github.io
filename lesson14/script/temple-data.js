...
let card = document.createElement('section');
  ...
  h2.textContent = temples[i].name;
        ...
        p5.textContent = temples[i].servicesClothing;
        p6.textContent = temples[i].servicesCafeteria;
        p7.textContent = temples[i].servicesHousing;
        p8.textContent = temples[i].servicesDistCenter;
  card.appendChild(h2);
        card.appendChild(p1);
        card.appendChild(p2);
        card.appendChild(p3);
